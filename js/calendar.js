const services = {
  ...
  handbuilding: { title: 'Лепка из глины', meta: 'Создаём руками · 2 часа', price: 'от 2 200 ₽' },
  painting: { title: 'Роспись керамики', meta: 'Цвет, детали и готовая форма · 2 часа', price: 'от 1 800 ₽' },
  date: { title: 'Свидание для двоих', meta: 'Ваш вечер в мастерской · 2 часа', price: 'от 5 500 ₽' },
  family: { title: 'Семейный подряд', meta: 'Время вместе за одним столом · 2 часа', price: 'от 4 500 ₽' },
  kids: { title: 'Детский мастер-класс', meta: 'Для маленьких авторов · 2 часа', price: 'от 1 600 ₽' },
  course: { title: 'Обучающий курс', meta: 'Несколько встреч и больше навыка · 2 часа', price: 'от 9 900 ₽' },
